...
class CountOrders extends Model
{
    /**
     * Construct new Vleks\SDK\Results\CountOrders
     *
     ...
     *
     * @param   string  $xml
     * @return  object  Vleks\SDK\Results\CountOrders
    ...
    public static function fromXML($xml)
    {
        ...
        if (1 === $response->length) {
            return new CountOrders($response->item(0));
        } else {
            throw new ClientException('Unable to construct CountOrder response from provided XML.');
        }
    }
