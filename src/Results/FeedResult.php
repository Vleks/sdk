...
{
    /**
     * Construct new Vleks\SDK\Results\FeedResult
     *
    ...
    {
        $this->fields = array (
            'Feed'            => array ('value' => array (), 'type' => array(Entities\FeedResult::class)),
    ...
    /**
     * Construct new Vleks\SDK\Results\FeedResult from XML string
     *
     * @param   string  $xml
    ...
    public static function fromXML($xml)
    {
        ...
        if (1 === $response->length) {
            return new FeedResult($response->item(0));
        } else {
            throw new ClientException('Unable to construct FeedResult response from provided XML.');
        }
    }
    ...
    /**
     * Feed property method aliasses for convenience
     */
