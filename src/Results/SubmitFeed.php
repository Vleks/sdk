...
class SubmitFeed extends Model
{
    /**
     * Construct new Vleks\SDK\Results\SubmitFeed
     *
    ...
    /**
     * Construct new Vleks\SDK\Results\SubmitFeed from XML string
     *
     * @param   string  $xml
    ...
    public function fromXML($xml)
    {
        ...
        if (1 === $response->length) {
            ...
            throw new ClientException('Unable to construct SubmitFeed response from provided XML.');
        }
    }
