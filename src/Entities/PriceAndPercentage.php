...
class PriceAndPercentage extends Model
{
    public function __construct($data = null)
    {
        $this->fields = array (
            ...
            'Percentage' => array ('value' => null, 'type' => 'float')
        );
    ...
    {
        $this->fields['Amount']['value'] = (float) $value;
        return $this;
    }
    ...
    {
        $this->fields['Percentage']['value'] = (float) $value;
        return $this;
    }

    public function getPercentage ()
    {
        return $this->fields['Percentage']['value'];
    }

    public function hasPercentage ()
    {
        return !is_null($this->fields['Percentage']['value']);
    }
}
